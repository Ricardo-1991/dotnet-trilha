    ...
    public partial class AddAtendimentoExame : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Antendimentos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Antendimentos_Medicos_MedicoId",
                        column: x => x.MedicoId,
                        principalTable: "Medicos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Antendimentos_Pacientes_PacienteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Antendimentos_MedicoId",
                table: "Antendimentos",
                column: "MedicoId");

            migrationBuilder.CreateIndex(
                name: "IX_Antendimentos_PacienteId",
                table: "Antendimentos",
                column: "PacienteId");
